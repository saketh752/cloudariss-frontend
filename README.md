...
[![Live Demo](https://img.shields.io/badge/Live_Demo-cloudariss--frontend.vercel.app-0878E8?style=for-the-badge&logo=vercel&logoColor=white)](https://cloudariss-frontend.vercel.app)
[![GitHub Repo](https://img.shields.io/badge/GitHub-Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/saketh752/cloudariss-frontend)
...
[![Vercel](https://img.shields.io/badge/Vercel-Deployed-black?style=flat-square&logo=vercel&logoColor=white)](https://cloudariss-frontend.vercel.app)
...
| :--- | :--- | :---: | :--- |
| **Brand Navy** | `#071B63` | `![#071B63](https://placehold.co/15x15/071B63/071B63.png)` | Primary brand dark background and surface tints |
| **Brand Blue** | `#0878E8` | `![#0878E8](https://placehold.co/15x15/0878E8/0878E8.png)` | Primary interactive buttons, focus states, links |
| **Brand Cyan** | `#19BCE8` | `![#19BCE8](https://placehold.co/15x15/19BCE8/19BCE8.png)` | Badges, gradient accents, highlights, tech tags |
| **Brand Orange** | `#FF7A00` | `![#FF7A00](https://placehold.co/15x15/FF7A00/FF7A00.png)` | Limited-time promotional offers, urgency badges |
| **Dark Base** | `#060C1E` | `![#060C1E](https://placehold.co/15x15/060C1E/060C1E.png)` | Deep page canvas background |
| **Dark Card** | `#0D1630` | `![#0D1630](https://placehold.co/15x15/0D1630/0D1630.png)` | Card surfaces with subtle border strokes |
...
flowchart TD
    ...
    subgraph Design ["UI & Component System"]
        B --> C[Layout: TopBanner + Navbar + Footer]
        C --> D[Pages: Home, Courses, CRPC, DAAP, Offerings, Why, About, Contact, Verify]
        D --> E[Reusable Primitives: Button, Card, Badge, TechChip, SectionHeading]
    end

    subgraph Build ["Build & Distribution Pipeline"]
        E --> F[Vite 6 Bundler]
        F --> G[Tailwind CSS PostCSS Engine]
        G --> H[TypeScript Strict Compilation]
        H --> I[Vercel Edge Global Network]
    end

    I --> J((Live Site: cloudariss-frontend.vercel.app))
```
...
- 💬 **WhatsApp Us**: [![WhatsApp](https://img.shields.io/badge/Chat_on_WhatsApp-25D366?style=flat-square&logo=whatsapp&logoColor=white)](https://wa.me/916302680457)
- 📸 **Instagram**: [![Instagram](https://img.shields.io/badge/@cloudariss.tech-E4405F?style=flat-square&logo=instagram&logoColor=white)](https://www.instagram.com/cloudariss.tech/?hl=en)
- 💼 **LinkedIn**: [![LinkedIn](https://img.shields.io/badge/Cloudariss_Technologies-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/company/cloudariss-technologies/posts/?feedView=all)
